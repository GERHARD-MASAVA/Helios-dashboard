...
def fetch_market_news():
    """Fetch top market news headlines (with images)."""
    url = "https://newsapi.org/v2/top-headlines"
    params = {
        "category": "business",
        "language": "en",
        "apiKey": "5eb57893abfb4d54b2c2036ee2a21991"  # replace with your key
    }
    try:
        ...
        return [{"title": f"Error fetching news: {e}", "source": "System", "url": "#", "description": "", "urlToImage": None}]
...
# -----------------------
# --- Market News Tab (with thumbnails and safe refresh)
# -----------------------
with tab4:
    st.header("Latest Market News")
    
    # Session state for news refresh
    ...
    if st.session_state.refresh_news or not st.session_state.news_loaded:
        ...
        with st.container():
            ...
            with col1:
                if item.get("urlToImage"):
                    st.image(item["urlToImage"], use_container_width=True)
            with col2:
